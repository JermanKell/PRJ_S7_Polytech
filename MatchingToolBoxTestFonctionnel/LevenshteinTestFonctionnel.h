#ifndef LEVENSHTEINTEST_FFONCTIONNEL_H
#define LEVENSHTEINTEST_FFONCTIONNEL_H

#include "GtestEnvironment.h"

class Levenshtein_SystemTest : public ::testing::Test {
	protected:
		/*!
...
#endif  // LEVENSHTEINTEST_FFONCTIONNEL_H